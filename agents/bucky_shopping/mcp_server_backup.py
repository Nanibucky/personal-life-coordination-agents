...
class BuckyMCPServer(BaseMCPServer):
    ...
    def __init__(self):
        ...
        # Initialize tools
        self.deal_finder = DealFinderTool()
        self.pantry_tracker = PantryTrackerTool()
        self.price_comparator = PriceComparatorTool()
        self.shopping_optimizer = ShoppingOptimizerTool()
    
    async def initialize_agent(self):
        """Initialize Bucky's tools and resources"""
        
        # Register pantry tracker tool
        self.register_tool(
            name="pantry_tracker",
            description="Track household inventory with smart replenishment alerts and expiration monitoring",
            input_schema={
                "type": "object",
                "properties": {
                    "action": {
                        ...
                        "description": "Action to perform on pantry inventory"
                    },
                    ...
                    "barcode": {"type": "string", "description": "Barcode for scanning"},
                    "receipt_data": {"type": "string", "description": "Receipt text for scanning"},
                    "reorder_point": {"type": "number", "description": "Minimum quantity before reordering"},
                    "days_ahead": {"type": "integer", "default": 7, "description": "Days to predict needs"}
                },
                "required": ["action"]
            },
            function=self._handle_pantry_tracker
        )
        
        # Register deal finder tool
        self.register_tool(
            name="deal_finder",
            description="Find deals, coupons, and optimize savings across stores",
            input_schema={
                "type": "object",
                "properties": {
                    "action": {
                        ...
                        "description": "Deal finding action"
                    },
                    "items": {
                        "type": "array",
                        "items": {"type": "string"},
                    ...
                    "budget_limit": {"type": "number", "description": "Maximum budget for deals"},
                    "deal_types": {
                        "type": "array",
                        "items": {
                            "type": "string",
                        ...
                        "description": "Types of deals to search for"
                    },
                    "savings_threshold": {"type": "number", "description": "Minimum savings percentage"}
                },
                "required": ["action"]
            },
            function=self._handle_deal_finder
        )
        
        # Register price comparator tool
        self.register_tool(
            name="price_comparator",
            description="Compare prices across stores and track price history",
            input_schema={
                "type": "object",
                "properties": {
                    "action": {
                        "type": "string",
                        "enum": ["compare_prices", "track_price_history", "set_price_alert", "get_best_deals", "analyze_trends"],
                        "description": "Price comparison action"
                    },
                    "items": {
                        "type": "array",
                        "items": {"type": "string"},
                        "description": "Items to compare prices for"
                    },
                    "stores": {
                        "type": "array",
                        "items": {"type": "string"},
                        "description": "Stores to compare prices across"
                    },
                    "brand_preference": {"type": "string", "description": "Preferred brand"},
                    "price_threshold": {"type": "number", "description": "Price alert threshold"},
                    "time_period": {"type": "string", "description": "Time period for price history"}
                },
                "required": ["action"]
            },
            function=self._handle_price_comparator
        )
        
        # Register shopping optimizer tool
        self.register_tool(
            name="shopping_optimizer",
            description="Create and optimize shopping lists with route planning and budget management",
            input_schema={
                "type": "object",
                "properties": {
                    "action": {
                        "type": "string",
                        "enum": ["create_list", "optimize_route", "budget_analysis", "consolidate_trips", 
                                "suggest_alternatives", "schedule_shopping"],
                        "description": "Shopping optimization action"
                    },
                    "shopping_list": {
                        "type": "array",
                        "items": {
                    ...
                    "budget": {"type": "number", "description": "Shopping budget"},
                    "preferred_stores": {
                        "type": "array",
                        "items": {"type": "string"},
                        "description": "Preferred stores"
                    },
                    "time_constraints": {"type": "string", "description": "Time constraints for shopping"},
                    "transportation": {"type": "string", "enum": ["car", "walking", "public_transport"]},
                    "location": {"type": "string", "description": "Starting location for route optimization"}
                },
                "required": ["action"]
            },
            function=self._handle_shopping_optimizer
        )
                        "type": "string",
